...
<div class="container padding-top padding-left padding-right">
    <div id="categary_hot_soft">
        <!--{applist parent=1 id=$cate_id page=$page per_page=12}-->
        <div class="line">
                ...
                <a href="<!--{link m='app' app_id=$applist.app_id}-->">
                    ...
                    <div class="xs9 xm9 xl9 xb9 padding-left">
                        ...
                        <p class="text-left height-little margin-small-bottom text-small text-gray">
                            <!--{countdown down=$applist.app_down}-->下载<span>|</span><!--{round($applist.history_size/1024/1024,2)}-->
                            MB</p>
                    </div>
                </a>
            </div>
            <div class="xs3 xm3 xl3 xb3">
                <div class="float-right padding-top"><a href="<!--{link m='app' app_id=$applist.app_id}-->"
